(function(g){var window=this;'use strict';var Cdb=function(a){g.T.call(this,{G:"div",K:"ytp-miniplayer-ui"});this.Qf=!1;this.player=a;this.N(a,"minimized",this.Oh);this.N(a,"onStateChange",this.XN)},Ddb=function(a){g.VQ.call(this,a);
this.u=new g.IF(this);this.j=new Cdb(this.player);this.j.hide();g.mQ(this.player,this.j.element,4);a.gg()&&(this.load(),g.io(a.getRootNode(),"ytp-player-minimized",!0));this.player.S("web_rounded_containers")&&g.io(a.getRootNode(),"ytp-rounded-miniplayer",!0)};
g.v(Cdb,g.T);g.k=Cdb.prototype;
g.k.eL=function(){this.tooltip=new g.aV(this.player,this);g.E(this,this.tooltip);g.mQ(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.Pc=new g.OR(this.player);g.E(this,this.Pc);this.cj=new g.T({G:"div",K:"ytp-miniplayer-scrim"});g.E(this,this.cj);this.cj.Ca(this.element);this.N(this.cj.element,"click",this.cG);var a=new g.T({G:"button",Ga:["ytp-miniplayer-close-button","ytp-button"],X:{"aria-label":"Close"},W:[g.lN()]});g.E(this,a);a.Ca(this.cj.element);this.N(a.element,"click",this.Fo);
a=new g.y2(this.player,this);g.E(this,a);a.Ca(this.cj.element);this.Zt=new g.T({G:"div",K:"ytp-miniplayer-controls"});g.E(this,this.Zt);this.Zt.Ca(this.cj.element);this.N(this.Zt.element,"click",this.cG);var b=new g.T({G:"div",K:"ytp-miniplayer-button-container"});g.E(this,b);b.Ca(this.Zt.element);a=new g.T({G:"div",K:"ytp-miniplayer-play-button-container"});g.E(this,a);a.Ca(this.Zt.element);var c=new g.T({G:"div",K:"ytp-miniplayer-button-container"});g.E(this,c);c.Ca(this.Zt.element);this.cV=new g.uT(this.player,
this,!1);g.E(this,this.cV);this.cV.Ca(b.element);b=new g.sT(this.player,this);g.E(this,b);b.Ca(a.element);this.nextButton=new g.uT(this.player,this,!0);g.E(this,this.nextButton);this.nextButton.Ca(c.element);this.gj=new g.OU(this.player,this);g.E(this,this.gj);this.gj.Ca(this.cj.element);this.Jc=new g.FT(this.player,this);g.E(this,this.Jc);g.mQ(this.player,this.Jc.element,4);this.SF=new g.T({G:"div",K:"ytp-miniplayer-buttons"});g.E(this,this.SF);g.mQ(this.player,this.SF.element,4);a=new g.T({G:"button",
Ga:["ytp-miniplayer-close-button","ytp-button"],X:{"aria-label":"Close"},W:[g.lN()]});g.E(this,a);a.Ca(this.SF.element);this.N(a.element,"click",this.Fo);a=new g.T({G:"button",Ga:["ytp-miniplayer-replay-button","ytp-button"],X:{"aria-label":"Close"},W:[g.sN()]});g.E(this,a);a.Ca(this.SF.element);this.N(a.element,"click",this.Q4);this.N(this.player,"presentingplayerstatechange",this.ud);this.N(this.player,"appresize",this.Cb);this.N(this.player,"fullscreentoggled",this.Cb);this.Cb()};
...
g.k.Q4=function(){this.player.playVideo()};
...
g.k.zq=function(){};
g.k.OD=function(){};
g.k.yr=function(){};g.v(Ddb,g.VQ);g.k=Ddb.prototype;g.k.onVideoDataChange=function(){if(this.player.S("web_rounded_containers")&&this.player.getVideoData()){var a=16/9;a=this.player.getVideoAspectRatio()>a+.1;g.io(this.player.getRootNode(),"ytp-rounded-miniplayer-extra-wide-video",a)}};
...
g.k.unload=function(){this.player.showControls();this.j.hide()};g.UQ("miniplayer",Ddb);})(_yt_player);
